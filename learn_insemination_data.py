...
layer1 = utils.create_fully_connected_layer(X_norm, 32, name="layer1")
layer1_norm = utils.create_batch_normalization_layer(layer1, is_training, scope='bn_layer1')
layer2 = utils.create_fully_connected_layer(layer1_norm, 32, name="layer2")
layer2_norm = utils.create_batch_normalization_layer(layer2, is_training, scope='bn_layer2')
layer3 = utils.create_fully_connected_layer(layer2_norm, 32, name="layer3")
layer3_norm = utils.create_batch_normalization_layer(layer3, is_training, scope='bn_layer3')
layer4 = utils.create_fully_connected_layer(layer3_norm, 32, name="layer4")
layer4_norm = utils.create_batch_normalization_layer(layer4, is_training, scope='bn_layer4')
Y_pred = utils.create_fully_connected_layer(layer4_norm, 2, name="layer5", activation=tf.nn.softmax)
